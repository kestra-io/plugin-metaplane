...
class GetTest extends AbstractMetaplaneTest {
    ...
    void fetchesMonitorStatus(WireMockRuntimeInfo wireMockRuntimeInfo) throws Exception {
        stubGetJson("/v2/monitors/status/3fa85f64-5717-4562-b3fc-2c963f66afa6", """
            {"id":"3fa85f64-5717-4562-b3fc-2c963f66afa6","status":"OK","checkedAt":"2024-01-01T00:00:00Z"}
            """);
        ...
        assertThat(output.getStatus(), is(MonitorStatus.OK));
    ...
    void unknownStatusValueFallsBackToUnknown(WireMockRuntimeInfo wireMockRuntimeInfo) throws Exception {
        stubGetJson("/v2/monitors/status/monitor-1", """
            {"id":"monitor-1","status":"SOMETHING_NEW"}
            """);
    ...
    void sendsBearerAuthorizationHeader(WireMockRuntimeInfo wireMockRuntimeInfo) throws Exception {
        ...
        verifyBearerAuth(getRequestedFor(urlPathEqualTo("/v2/monitors/status/monitor-1")), "my-secret-token");
    }
